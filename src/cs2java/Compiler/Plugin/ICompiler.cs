...
namespace JSharp.Compiler
{
    ...
    public interface ICompiler
    {
        ...
        //event Action<IEntity, JNode> AfterConvertCsToJsEntity;

        event Action<AstNode> BeforeConvertCsToJsAstNode;
        //event Action<AstNode, JNode> AfterConvertCsToJsAstNode;

        event Action<ResolveResult> BeforeConvertCsToJsResolveResult;
        //event Action<ResolveResult, JNode> AfterConvertCsToJsResolveResult;
