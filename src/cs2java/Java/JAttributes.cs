...
namespace JSharp
{
    ...
    ///<summary>
    /// Sets the rules that JSharp will use when converting this .NET type into JavaScript.
    ...
    public partial class JTypeAttribute : Attribute
    {
        /// <summary>
        /// Creates an instance of a JsTypeAttribute
        /// </summary>
        public JTypeAttribute()
        {
        }
        ...
        ///// This feature should be used when trying to describe classes on external assemblies that has no JSharp support
        ///// </summary>
        ...
        /// <summary>
        /// When set to true - JSharp will ignore all params[] keywords in all methods
        /// </summary>
        ...
        /// <summary>
        ///	Indicates that JSharp compiler will generate javascript code for this type / member
        ...
        /// <summary>
        /// Targets the attribute for a specific JSharp version, this attribute will be ignored if the current 
        /// JSharp version isn't in the range of the value specified
        /// </summary>
        public string JSharpVersion { get; set; }
        /// <summary>
    ...
    /// <summary>
    /// Provides information regarding how JSharp will export JavaScript code
    /// </summary>
    [AttributeUsage(AttributeTargets.Assembly, AllowMultiple = true)]
    public partial class JExportAttribute : Attribute
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies whether JSharp should minify the exported files
        /// </summary>
        public bool Minify { get { return _Minify.GetValueOrDefault(); } set { _Minify = value; } } public bool? _Minify;
        /// <summary>
        /// Instructs JSharp to provide any exported function with a global unique name, to help debugging of client side code.
        /// </summary>
        ...
        /// <summary>
        /// Specifies prefix / suffix to any filename exported by JSharp, e.g.: FilenameFormat="js/{0}"
        /// </summary>
        ...
        /// <summary>
        /// Specifies to inject all available helper methods generated by JSharp into a single separate file, this feature is supported by JSharp 5 only.
        /// </summary>
        ...
        /// <code>
        /// &lt;add name="SourceMapsHandler" type="JSharp.Web.Server.Handlers.SourceMapsHandler, JSharp.Web" verb="*" path="SourceMaps.ashx" /&gt;
        /// </code>
        ...
        /// <summary>
        /// Instructs JSharp to use '===' and '!==' (exact equals/not equals) instead of '==' / '!=' when checking equality between objects.
        ...
        /// <summary>
        /// Removes the 'Generated by JSharp 5 v...' header comment in js files
        /// </summary>
        public bool OmitJSharpHeaderComment { get { return _OmitJSharpHeaderComment.GetValueOrDefault(); } set { _OmitJSharpHeaderComment = value; } } public bool? _OmitJSharpHeaderComment;
    ...
    ///<summary>
    ///Instructs JSharp Compiler to create a merged file from specified sources
    ///</summary>
    [AttributeUsage(AttributeTargets.Assembly, AllowMultiple = true)]
    ...
    ///<summary>
    /// Specifies custom instructions for JSharp for a single method, this information is used when exporting the member, and when using it.
    ///</summary>
    [AttributeUsage(AttributeTargets.Assembly | AttributeTargets.Method | AttributeTargets.Constructor, AllowMultiple = true)]
    public partial class JMethodAttribute : Attribute
    {
        /// <summary>
        /// When set to true, JSharp will ignore the params[] keyword on the method parameter
        /// </summary>
        public bool NativeParams { get { return _NativeParams.GetValueOrDefault(); } set { _NativeParams = value; } } public bool? _NativeParams;
        /// <summary>
        ...
        /// <summary>
        /// Instructs JSharp to use a custom name for a method, JSharp will use this name when exporting the method, and when invoking it.
        /// </summary>
        public string Name { get; set; }
        ///<summary>
    ...
    ///<summary>
    /// Specifies custom instructions for JSharp for a property, this information is used when exporting the member, and when using it.
    ///</summary>
    [AttributeUsage(AttributeTargets.Property | AttributeTargets.Assembly, AllowMultiple = true)]
    public partial class JPropertyAttribute : Attribute
    {
        ///<summary>
    ...
    ///<summary>
    /// Specifies custom instructions for JSharp for an event, this information is used when exporting the member, and when using it.
    ///</summary>
    ...
    ///<summary>
    /// Specifies custom instructions for JSharp for a delegate, this information is used when exporting the member, and when using it.
    ///</summary>
    ...
    public partial class JEnumAttribute : Attribute
    {
        /// <summary>
    ...
    public partial class JFieldAttribute : Attribute
    {
        /// <summary>
        ///	Indicates that JSharp compiler will generate javascript code for this field
        /// This property is inherited and applied to all derived types. Default value is true
        /// </summary>
        public bool Export { get { return _Export.GetValueOrDefault(true); } set { _Export = value; } } public bool? _Export;
        /// <summary>
        /// Instructs JSharp to use a custom name for this field, JSharp will use this name when exporting the field, and when using it in code.
        /// </summary>
        public string Name { get; set; }
    }
    #endregion
    ...
    [AttributeUsage(AttributeTargets.Assembly, AllowMultiple = true)]
    public partial class JEmbeddedResourceAttribute : Attribute
    {
        public JEmbeddedResourceAttribute()
        {
        }
        public JEmbeddedResourceAttribute(string filename)
        {
            Filename = filename;
        }
        public JEmbeddedResourceAttribute(string filename, string resourceName)
        {
