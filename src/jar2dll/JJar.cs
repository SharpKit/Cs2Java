...
namespace JSharp.Utils
{
    ...
    public class JClass : JMember
    {
        public JClass()
        {
            ...
            Methods = new List<JMethod>();
            Ctors = new List<JConstructor>();
            Classes = new List<JClass>();
            Interfaces = new List<JClassRef>();
            GenericArguments = new List<JClassRef>();
    ...
    public class JMethod : JMember
    {
        public JMethod()
        {
            Parameters = new List<JParameter>();
            TypeParameters = new List<JClassRef>();
        }
